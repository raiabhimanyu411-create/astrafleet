...
export const updateCustomerInline = (id, data) => api.patch(`/api/customers/${id}/inline`, data);
export const updateCustomerStatus = (id, data) => api.patch(`/api/customers/${id}/status`, data);
